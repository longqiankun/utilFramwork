...
import com.lqk.framework.db.annotation.Check;
import com.lqk.framework.db.annotation.Column;
import com.lqk.framework.db.annotation.Finder;
import com.lqk.framework.db.annotation.Foreign;
import com.lqk.framework.db.annotation.Id;
import com.lqk.framework.db.annotation.NotNull;
import com.lqk.framework.db.annotation.Transient;
import com.lqk.framework.db.annotation.Unique;
import com.lqk.framework.db.sqlite.FinderLazyLoader;
import com.lqk.framework.db.sqlite.ForeignLazyLoader;
...
public class ColumnUtils {
    ...
    public static Class<?> getForeignEntityType(com.lqk.framework.db.table.Foreign foreignColumn) {
    ...
    @SuppressWarnings("unchecked")
    public static Class<?> getFinderTargetEntityType(com.lqk.framework.db.table.Finder finderColumn) {
