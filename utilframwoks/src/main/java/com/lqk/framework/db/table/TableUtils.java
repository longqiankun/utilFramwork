...
package com.lqk.framework.db.table;
...
import com.lqk.framework.db.annotation.Id;
...
public class TableUtils {
	...
	public static Column getColumnOrId(Class<?> entityType, String columnName) {
		if (getPrimaryKeyColumnName(entityType).equals(columnName)) {
			return com.lqk.framework.db.table.Table.get(entityType).getId();
		}
	 ...
	 * key: entityType.canonicalName
	 */
	private static ConcurrentHashMap<String, com.lqk.framework.db.table.Id> entityIdMap = new ConcurrentHashMap<String, com.lqk.framework.db.table.Id>();

	public static synchronized com.lqk.framework.db.table.Id getId(Class<?> entityType) {
		if (Object.class.equals(entityType)) {
		...
		com.lqk.framework.db.table.Id id = new com.lqk.framework.db.table.Id(entityType, primaryKeyField);
		entityIdMap.put(entityType.getCanonicalName(), id);
		return id;
	}

	private static String getPrimaryKeyFieldName(Class<?> entityType) {
		com.lqk.framework.db.table.Id id = getId(entityType);
	...
	public static Object getIdValue(Object entity) {
		...
		try {
			com.lqk.framework.db.table.Id id = getId(entity.getClass());
			if (id == null)
				return null;
