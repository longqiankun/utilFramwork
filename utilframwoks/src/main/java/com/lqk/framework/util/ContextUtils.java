...
import com.lqk.framework.core.kernel.KernelString;
import com.lqk.framework.inject.InjectAll;
import com.lqk.framework.inject.InjectBefore;
...
import com.lqk.framework.inject.InjectListener;
import com.lqk.framework.inject.InjectMethod;
import com.lqk.framework.inject.InjectOnNewIntent;
import com.lqk.framework.inject.InjectPLayer;
import com.lqk.framework.inject.InjectPause;
import com.lqk.framework.inject.InjectPullRefresh;
import com.lqk.framework.inject.InjectResource;
import com.lqk.framework.inject.InjectRestart;
import com.lqk.framework.inject.InjectResume;
import com.lqk.framework.inject.InjectStart;
...
import com.lqk.framework.invoker.InjectHttps;
import com.lqk.framework.invoker.InjectInvoker;
import com.lqk.framework.invoker.InjectLayers;
import com.lqk.framework.invoker.InjectMethods;
import com.lqk.framework.invoker.InjectObjects;
import com.lqk.framework.invoker.InjectPLayers;
import com.lqk.framework.invoker.InjectResources;
import com.lqk.framework.invoker.InjectViews;
import com.lqk.framework.invoker.InjectViews.Views;
	...
	public static ArrayList<InjectInvoker> getViewInvokers(final Class<?> clazz, final Object obj, final Class<?> superClass) {
		...
		while (template != null && template != Object.class && template != superClass) {
			...
			for (int i = 0; i < fields.length; i++) {
				...
				// 对象绑定
				InjectObject Injectobj = field.getAnnotation(InjectObject.class);
				if (Injectobj != null) {
					InjectObjects injectObjects = new InjectObjects(field, null, null);
						local_list.add(injectObjects);
				}
			}
