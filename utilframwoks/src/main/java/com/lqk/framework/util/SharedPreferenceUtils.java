...
public class SharedPreferenceUtils {
	...
	public static void WriteSp(Context context, String dataBasesName, ThreeMap map) {
		if (map == null) {
			return;
		}
	...
	public static void ClearSp (Context context, String dataBasesName) {
		SharedPreferences user = context.getSharedPreferences(dataBasesName, 0);
		Editor editor = user.edit();
		editor.clear();
		editor.commit();
	...
	public static void removeSp(Context context, String dataBasesName, String key) {
		SharedPreferences user = context.getSharedPreferences(dataBasesName, 0);
		Editor editor = user.edit();
		editor.remove(key);
		editor.commit();
	...
	public static SharedPreferences ReadSp(Context context, String dataBasesName) {
		SharedPreferences user = context.getSharedPreferences(dataBasesName, 0);
		return user;
	}
	...
	public static void WriteSp(Context context, String dataBasesName, String name, Object value) {
